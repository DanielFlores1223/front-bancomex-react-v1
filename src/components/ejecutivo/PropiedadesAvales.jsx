...
const PropiedadesAvales = ({
  ...
  const [guarantees, setGuarentees] = useState(
    JSON.parse(localStorage.getItem("gua"))
  );
  ...
  const savePropierties = async (e, gId, noTextField) => {
    ...
    if (!validateForm(valueInputF, noTextField)) return;
        ...
        {guarantees && guarantees.length === 0 && (
          <Grid container justifyContent="center" alignItems="center">
            <Grid
              ...
              alignItems="center"
              direction="column"
              style={{ width: "30rem", height: "20rem", textAlign: "center" }}
            >
              <Typography variant="h5" color="initial">
                Se ha solicitado el credito Hipotecario,es necesario que el
                Gerente apruebe el credito
              </Typography>
              <Button
                color="primary"
                variant="contained"
