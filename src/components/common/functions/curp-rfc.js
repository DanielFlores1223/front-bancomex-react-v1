export function calcula(ap_paterno, ap_materno, nombre, f_nac, sexo, estado) {

    // sacar datos por fecha de nac
    const arrayFNac = f_nac.split('-');
...
function RFCArmalo(ap_paterno, ap_materno, nombre) {
    ...
    for (let i = 1; i <= ap_paterno.length; i++) {
        ...
        if (y == 0) {
            for (let x = 0; x <= strVocales.length; x++) {
...
function fnCalculaCURP(pstNombre, pstPaterno, pstMaterno, dfecha, pstSexo, pnuCveEntidad) {
    ...
    let AMATERNO = "";
    let T_NOMTOT = "";
    let NOMBRE1 = ""; //PRIMER NOMBRE
    let NOMBRE2 = ""; //DEMAS NOMBRES
    let NOMBRES_LONGITUD = 0; //LONGITUD DE TODOS @NOMBRES
    var NOMBRE1_LONGITUD = 0; //LONGITUD DEL PRIMER NOMBRE(MAS UNO,EL QUE SOBRA ES UN ESPACIO EN BLANCO)
    let APATERNO1 = ""; //PRIMER NOMBRE
    let APATERNO2 = ""; //DEMAS NOMBRES
    let APATERNO_LONGITUD = 0; //LONGITUD DE TODOS @NOMBRES
    let APATERNO1_LONGITUD = 0; //LONGITUD DEL PRIMER NOMBRE(MAS UNO,EL QUE SOBRA ES UN ESPACIO EN BLANCO)
    let AMATERNO1 = ""; //PRIMER NOMBRE
    let AMATERNO2 = ""; //DEMAS NOMBRES
    let AMATERNO_LONGITUD = 0; //LONGITUD DE TODOS @NOMBRES
    let AMATERNO1_LONGITUD = 0; //LONGITUD DEL PRIMER NOMBRE(MAS UNO,EL QUE SOBRA ES UN ESPACIO EN BLANCO)
    let VARLOOPS = 0; //VARIABLE PARA LOS LOOPS, SE INICIALIZA AL INICIR UN LOOP
