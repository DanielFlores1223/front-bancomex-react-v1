          ...
          <Grid container>
              ...
              >
                  <Button color='primary' 
                          variant="contained" 
                          onClick={() => { navigateTo('/hacer-corte') }}
                  >
                        Hacer corte
                  </Button>
              </Grid>
               ...
               >
                   ...
                   <Typography variant='body1' paragraph={true}> 
                          ...
                          <Typography variant='body1'> 
                              <b>Cantidad de efectivo inicial: </b> { `$${info.totalStart} MXN` }
                          </Typography>
                          <Typography variant='body1'> 
                              <b>Fecha de apertura: </b> { info.date.split('T')[0] }
                          </Typography>
                          <Typography variant='body1'> 
                              <b>Hora de apertura: </b> { new Date(info.date).toLocaleTimeString() }
                          </Typography>
                          <Typography variant='body1'> 
                            <b>Cajero: </b> { `${info.Employee.firstName} ${info.Employee.lastName}` }
                          </Typography>
                  </Typography>
               </Grid>
          </Grid>
          ...
          <Grid container>
              ...
              <Grid item xs={12}>
                <Typography variant='body1' align='center' style={{marginTop:'3rem'}}> 
                       <b>Nota: </b> Para poder cerrar sesión, necesitas hacer corte en la caja.
                </Typography>
              </Grid>
